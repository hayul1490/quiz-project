// js/main.js
const YOUTUBE_VIDEO_ID_1 = "https://youtu.be/2xxNtPi_-Sw?si=hWFlBUcfnbsIRhvL"; // 📍 여기에 인트로 후 재생할 유튜브 영상 ID
const YOUTUBE_VIDEO_ID_2 = "https://youtu.be/2xxNtPi_-Sw?si=hWFlBUcfnbsIRhvL"; // 📍 여기에 퀴즈 결과 후 재생할 유튜브 영상 ID
